...
const validPastas = [
    'Jambalaya Linguini Fini', 'Chicken Tequila Fettuccine', 
    'Garlic Cream Fettuccine', 'Shrimp Scampi Zucchini', 'Tomato Basil Spaghetti', 
    'Kung Pao Spaghetti', 'Bolognese Spaghetti'
]
...
const validMocktails = [
    'Sparkling Berry-Lemon', 'Fresh Strawberry Mango Cooler',
    'Cucumber Reviver', 'Pacific Thyme'
]
...
const validCocktails = [
    'CPK Old Fashioned', 'Sparkling Mojito', 'California Colada',
    'Tropical Mule', 'Bourbon Peach Smash', 'Endless Sunshine'
]
